...
This mechanism has been integrated into Bitcore-Node-Wuazi which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/wuazipay/insight-api-wuazi#web-socket-api](https://github.com/wuazipay/insight-api-wuazi#web-socket-api)
* API: [https://github.com/wuazipay/insight-api-wuazi#instantsend-transactions](https://github.com/wuazipay/insight-api-wuazi#instantsend-transactions)
...
By default, the Wuazi Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Wuazi Core daemon:
