...
Only requiring some minor changes is wuazi.cpp.
...
Changes to wuazi.cpp
----------------------
wuazi.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
