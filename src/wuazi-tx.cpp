...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Wuazi Core wuazi-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  wuazi-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wuazi transaction") + "\n" +
              "  wuazi-tx [options] -create [commands]   " + _("Create hex-encoded wuazi transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded wuazi transaction
