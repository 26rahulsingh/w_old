...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "WuaziNetwork") type = WuaziNetwork;
    if(strType == "WuaziNetworkVariable") type = WuaziNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == WuaziNetwork) s = "WuaziNetwork";
    if(type == WuaziNetworkVariable) s = "WuaziNetworkVariable";
