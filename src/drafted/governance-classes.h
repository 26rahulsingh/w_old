 ...
 *
 *   // network
 *   CWuaziNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.wuazi.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CWuaziNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: WuaziNetwork
// //   -- signature requirements : Key1(User)
// class CWuaziNetworkVariable : public CGovernanceObject
// {
// private:
