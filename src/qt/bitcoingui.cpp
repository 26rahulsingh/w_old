    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Wuazi Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Wuazi address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and wuazi: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Wuazi Core"), this);
    aboutAction->setStatusTip(tr("Show information about Wuazi Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Wuazi Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Wuazi addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Wuazi addresses"));
    ...
    openAction->setStatusTip(tr("Open a wuazi: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Wuazi Core help message to get a list with possible Wuazi Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Wuazi Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Wuazi network", "", count));
    } else {
...
{
    QString strTitle = tr("Wuazi Core"); // default title
