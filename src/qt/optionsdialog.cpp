    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("WAZ-light"), QVariant("light"));
    ui->theme->addItem(QString("WAZ-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("WAZ-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("WAZ-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("WAZ-traditional"), QVariant("trad"));
