    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Wuazi Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Wuazi Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  wuazi-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Wuazi in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 WAZ, 0.1 WAZ, 1 WAZ and 10 WAZ -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://wuazipay.atlassian.net/wiki/display/DOC/PrivateSend\">https://wuazipay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Wuazi Core is shutting down...") + "<br /><br />" +
