...
#define BOOST_TEST_MODULE Wuazi Test Suite

#include "test_wuazi.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_wuazi_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
